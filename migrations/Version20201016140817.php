 ...
 */
final class Version20201016140817 extends AbstractMigration
{
   ...
   //     $this->addSql('ALTER TABLE case_cochee_multiple ADD CONSTRAINT FK_1E5E006F6B899279 FOREIGN KEY (patient_id) REFERENCES patient (id)');
        $this->addSql('ALTER TABLE patient ADD commentaire_last LONGTEXT DEFAULT NULL');
    }
